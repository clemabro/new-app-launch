...
function moi(){  //objet vaisseau du hero
	...
	this.elem.src='./images/resInvasion/ship.png';
...
function mechant(){		//objet des soupes
	...
	this.elem=document.createElement('img');
	this.elem.src='./images/resInvasion/invader.png';
	this.elem.style.position='absolute';
	document.getElementById('dvg_jeux').appendChild(this.elem);
	
	this.aud=k_jeux_a.creason('./images/resInvasion/son/explosion');
...
mechant.prototype.init_envahisseur=function(){		//positionnement des soupes dans la page au demarrage du jeux et en cour de jeux.
	...
	el.src='./images/resInvasion/bonus.png';
	k_jeux_a.bonus='non';
	}
	else{
	el.src='./images/resInvasion/invader.png';
	}
...
function objet_tir(){		//objet des rayons laser
	...
	this.elem=document.createElement('img');
	this.elem.src='./images/resInvasion/lazer.png';
	this.elem.style.display='none';
	this.elem.style.position='absolute';
	document.getElementById('dvg_jeux').appendChild(this.elem);

	this.aud=k_jeux_a.creason('./images/resInvasion/son/laser_04');
...
objet_tir.prototype.tir=function(that){		//gestion du rayon laser quand il touche une soupe
	...
	for(var i = 0; i < k_jeux_a.tb_mechant.length; i++){
		...
		if(colision(that,k_jeux_a.tb_mechant[i],i)){
			...
			point(5);		//5 est le nombres de points quand une soucoupe est touch�
			...
			el2.src='./images/resInvasion/boum.png';
...
function accident(i){		//gestion de la colision entre les aliens et le vaisseau du hero
	...
	k_jeux_a.hero.elem.src='./images/resInvasion/ship_touche.png';
	k_jeux_a.hero_toucher=setTimeout(function(){k_jeux_a.hero.elem.src='./images/resInvasion/ship.png'},400);
	
	k_jeux_a.tb_mechant[i].elem.src='./images/resInvasion/boum.png';
...
function init(){		//creation des instance pour le jeux et gestion des options
	...
	k_jeux_a.son_vie_gagne=k_jeux_a.creason('./images/resInvasion/son/bonus');
	k_jeux_a.son_bonus=k_jeux_a.creason('./images/resInvasion/son/bonus_b');
